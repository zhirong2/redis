#include <include/RedisCommander.h>
...
RedisCommanderHandler::RedisCommanderHandler() {}

std::string RedisCommanderHandler::processCommand(const std::string& commandLine) {
